...
$$\frac{\partial h_{t_m}}{\partial W{ij}} \rightarrow \frac{\partial h_{t_m}}{\partial W{ij}} + \frac{\partial h_{t_m}}{\partial h_{{t-1}_n}} \frac{\partial h_{{t-1}_n}}{\partial W{ij}}$$

We can apply this again and again:

$$\frac{\partial h_{t_m}}{\partial W{ij}} \rightarrow \frac{\partial h_{t_m}}{\partial W{ij}} + $$
